...
import type { UvFileMoveChangeDetail } from './file-move.types'

const COMPONENT_LABEL = 'File Move'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvFileMoveChangeDetail]
  action: [detail: UvFileMoveChangeDetail]
}>()
