...
import type { UvDevicePickerChangeDetail } from './device-picker.types'

const COMPONENT_LABEL = 'Device Picker'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvDevicePickerChangeDetail]
  action: [detail: UvDevicePickerChangeDetail]
}>()
