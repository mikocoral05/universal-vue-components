...
import type { UvProfileStatsChangeDetail } from './profile-stats.types'

const COMPONENT_LABEL = 'Profile Stats'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvProfileStatsChangeDetail]
  action: [detail: UvProfileStatsChangeDetail]
}>()
