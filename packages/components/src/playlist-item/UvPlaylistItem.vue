...
import type { UvPlaylistItemChangeDetail } from './playlist-item.types'

const COMPONENT_LABEL = 'Playlist Item'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvPlaylistItemChangeDetail]
  action: [detail: UvPlaylistItemChangeDetail]
}>()
