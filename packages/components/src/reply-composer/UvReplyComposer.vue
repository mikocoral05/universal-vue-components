...
import type { UvReplyComposerChangeDetail } from './reply-composer.types'

const COMPONENT_LABEL = 'Reply Composer'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvReplyComposerChangeDetail]
  action: [detail: UvReplyComposerChangeDetail]
}>()
