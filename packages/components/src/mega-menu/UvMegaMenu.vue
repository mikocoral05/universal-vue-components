...
import type { UvMegaMenuChangeDetail } from './mega-menu.types'

const COMPONENT_LABEL = 'Mega Menu'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvMegaMenuChangeDetail]
  action: [detail: UvMegaMenuChangeDetail]
}>()
