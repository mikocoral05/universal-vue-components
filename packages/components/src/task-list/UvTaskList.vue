...
import type { UvTaskListChangeDetail } from './task-list.types'

const COMPONENT_LABEL = 'Task List'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvTaskListChangeDetail]
  action: [detail: UvTaskListChangeDetail]
}>()
