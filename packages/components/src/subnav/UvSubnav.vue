...
import type { UvSubnavChangeDetail } from './subnav.types'

const COMPONENT_LABEL = 'Subnav'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvSubnavChangeDetail]
  action: [detail: UvSubnavChangeDetail]
}>()
