...
import type { UvIssueDetailChangeDetail } from './issue-detail.types'

const COMPONENT_LABEL = 'Issue Detail'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvIssueDetailChangeDetail]
  action: [detail: UvIssueDetailChangeDetail]
}>()
