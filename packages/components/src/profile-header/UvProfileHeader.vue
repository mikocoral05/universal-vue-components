...
import type { UvProfileHeaderChangeDetail } from './profile-header.types'

const COMPONENT_LABEL = 'Profile Header'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvProfileHeaderChangeDetail]
  action: [detail: UvProfileHeaderChangeDetail]
}>()
