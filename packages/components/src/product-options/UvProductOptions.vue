...
import type { UvProductOptionsChangeDetail } from './product-options.types'

const COMPONENT_LABEL = 'Product Options'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvProductOptionsChangeDetail]
  action: [detail: UvProductOptionsChangeDetail]
}>()
