...
import type { UvMediaPlayerChangeDetail } from './media-player.types'

const COMPONENT_LABEL = 'Media Player'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvMediaPlayerChangeDetail]
  action: [detail: UvMediaPlayerChangeDetail]
}>()
