...
import type { UvPivotTableChangeDetail } from './pivot-table.types'

const COMPONENT_LABEL = 'Pivot Table'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvPivotTableChangeDetail]
  action: [detail: UvPivotTableChangeDetail]
}>()
