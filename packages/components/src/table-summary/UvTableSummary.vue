...
import type { UvTableSummaryChangeDetail } from './table-summary.types'

const COMPONENT_LABEL = 'Table Summary'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvTableSummaryChangeDetail]
  action: [detail: UvTableSummaryChangeDetail]
}>()
