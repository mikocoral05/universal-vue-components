...
import type { UvCrossTabChangeDetail } from './cross-tab.types'

const COMPONENT_LABEL = 'Cross Tab'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvCrossTabChangeDetail]
  action: [detail: UvCrossTabChangeDetail]
}>()
