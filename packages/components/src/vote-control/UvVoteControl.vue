...
import type { UvVoteControlChangeDetail } from './vote-control.types'

const COMPONENT_LABEL = 'Vote Control'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvVoteControlChangeDetail]
  action: [detail: UvVoteControlChangeDetail]
}>()
