...
import type { UvCartItemChangeDetail } from './cart-item.types'

const COMPONENT_LABEL = 'Cart Item'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvCartItemChangeDetail]
  action: [detail: UvCartItemChangeDetail]
}>()
