...
import type { UvPromoCodeInputChangeDetail } from './promo-code-input.types'

const COMPONENT_LABEL = 'Promo Code Input'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvPromoCodeInputChangeDetail]
  action: [detail: UvPromoCodeInputChangeDetail]
}>()
