...
import type { UvTableToolbarChangeDetail } from './table-toolbar.types'

const COMPONENT_LABEL = 'Table Toolbar'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvTableToolbarChangeDetail]
  action: [detail: UvTableToolbarChangeDetail]
}>()
