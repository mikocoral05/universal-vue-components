...
import type { UvCameraPreviewChangeDetail } from './camera-preview.types'

const COMPONENT_LABEL = 'Camera Preview'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvCameraPreviewChangeDetail]
  action: [detail: UvCameraPreviewChangeDetail]
}>()
