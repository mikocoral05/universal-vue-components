...
import type { UvMediaControlsChangeDetail } from './media-controls.types'

const COMPONENT_LABEL = 'Media Controls'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvMediaControlsChangeDetail]
  action: [detail: UvMediaControlsChangeDetail]
}>()
