...
import type { UvBioChangeDetail } from './bio.types'

const COMPONENT_LABEL = 'Bio'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvBioChangeDetail]
  action: [detail: UvBioChangeDetail]
}>()
