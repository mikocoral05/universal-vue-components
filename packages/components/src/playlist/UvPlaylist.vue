...
import type { UvPlaylistChangeDetail } from './playlist.types'

const COMPONENT_LABEL = 'Playlist'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvPlaylistChangeDetail]
  action: [detail: UvPlaylistChangeDetail]
}>()
