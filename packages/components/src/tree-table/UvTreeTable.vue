...
import type { UvTreeTableChangeDetail } from './tree-table.types'

const COMPONENT_LABEL = 'Tree Table'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvTreeTableChangeDetail]
  action: [detail: UvTreeTableChangeDetail]
}>()
