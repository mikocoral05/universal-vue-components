...
import type { UvFunnelChartChangeDetail } from './funnel-chart.types'
...
const emit = defineEmits<{
  ...
  change: [detail: UvFunnelChartChangeDetail]
  action: [detail: UvFunnelChartChangeDetail]
}>()
