...
import type { UvVideoPlayerChangeDetail } from './video-player.types'

const COMPONENT_LABEL = 'Video Player'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvVideoPlayerChangeDetail]
  action: [detail: UvVideoPlayerChangeDetail]
}>()
