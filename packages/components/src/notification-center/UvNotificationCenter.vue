...
import type { UvNotificationCenterChangeDetail } from './notification-center.types'
...
const emit = defineEmits<{
  ...
  change: [detail: UvNotificationCenterChangeDetail]
  action: [detail: UvNotificationCenterChangeDetail]
}>()
...
const accessibleLabel = computed(() => props.label || props.title || 'Notification Center')
...
function selectItem(item: UvGeneratedItem): void {
  ...
  const detail: UvNotificationCenterChangeDetail = { value, item, source: 'pointer' }
...
<template>
  <div class="uv-generated uv-notification-center" :class="[`uv-generated--${tone}`, `uv-generated--${orientation}`]" data-uv-component="UvNotificationCenter" :aria-label="accessibleLabel">
    <div class="uv-generated__surface">
      <header><h3 class="uv-generated__title">{{ title || label || 'Notification Center' }}</h3><p v-if="description" class="uv-generated__description">{{ description }}</p></header>
