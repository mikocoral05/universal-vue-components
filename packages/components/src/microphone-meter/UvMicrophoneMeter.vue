...
import type { UvMicrophoneMeterChangeDetail } from './microphone-meter.types'

const COMPONENT_LABEL = 'Microphone Meter'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvMicrophoneMeterChangeDetail]
  action: [detail: UvMicrophoneMeterChangeDetail]
}>()
