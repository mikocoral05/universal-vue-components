...
import type { UvDatabaseTableChangeDetail } from './database-table.types'

const COMPONENT_LABEL = 'Database Table'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvDatabaseTableChangeDetail]
  action: [detail: UvDatabaseTableChangeDetail]
}>()
