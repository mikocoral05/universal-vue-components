...
import type { UvSpreadsheetChangeDetail } from './spreadsheet.types'

const COMPONENT_LABEL = 'Spreadsheet'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvSpreadsheetChangeDetail]
  action: [detail: UvSpreadsheetChangeDetail]
}>()
