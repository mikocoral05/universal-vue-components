...
import type { UvProductListChangeDetail } from './product-list.types'

const COMPONENT_LABEL = 'Product List'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvProductListChangeDetail]
  action: [detail: UvProductListChangeDetail]
}>()
