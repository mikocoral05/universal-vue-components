...
import type { UvAudioPlayerChangeDetail } from './audio-player.types'

const COMPONENT_LABEL = 'Audio Player'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvAudioPlayerChangeDetail]
  action: [detail: UvAudioPlayerChangeDetail]
}>()
