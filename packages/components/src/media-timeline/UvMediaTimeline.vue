...
import type { UvMediaTimelineChangeDetail } from './media-timeline.types'

const COMPONENT_LABEL = 'Media Timeline'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvMediaTimelineChangeDetail]
  action: [detail: UvMediaTimelineChangeDetail]
}>()
