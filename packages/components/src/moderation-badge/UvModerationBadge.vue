...
import type { UvModerationBadgeChangeDetail } from './moderation-badge.types'

const COMPONENT_LABEL = 'Moderation Badge'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvModerationBadgeChangeDetail]
  action: [detail: UvModerationBadgeChangeDetail]
}>()
