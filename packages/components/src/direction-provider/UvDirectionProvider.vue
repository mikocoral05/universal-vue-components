...
import type { UvDirectionProviderChangeDetail } from './direction-provider.types'
...
const emit = defineEmits<{
  ...
  change: [detail: UvDirectionProviderChangeDetail]
  action: [detail: UvDirectionProviderChangeDetail]
}>()
