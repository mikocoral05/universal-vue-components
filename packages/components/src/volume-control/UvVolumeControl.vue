...
import type { UvVolumeControlChangeDetail } from './volume-control.types'

const COMPONENT_LABEL = 'Volume Control'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvVolumeControlChangeDetail]
  action: [detail: UvVolumeControlChangeDetail]
}>()
