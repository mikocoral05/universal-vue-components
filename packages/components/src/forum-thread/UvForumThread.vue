...
import type { UvForumThreadChangeDetail } from './forum-thread.types'

const COMPONENT_LABEL = 'Forum Thread'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvForumThreadChangeDetail]
  action: [detail: UvForumThreadChangeDetail]
}>()
