...
import type { UvTableFilterChangeDetail } from './table-filter.types'

const COMPONENT_LABEL = 'Table Filter'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvTableFilterChangeDetail]
  action: [detail: UvTableFilterChangeDetail]
}>()
