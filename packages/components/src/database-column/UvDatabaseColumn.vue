...
import type { UvDatabaseColumnChangeDetail } from './database-column.types'

const COMPONENT_LABEL = 'Database Column'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvDatabaseColumnChangeDetail]
  action: [detail: UvDatabaseColumnChangeDetail]
}>()
