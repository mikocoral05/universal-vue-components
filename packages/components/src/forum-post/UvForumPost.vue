...
import type { UvForumPostChangeDetail } from './forum-post.types'

const COMPONENT_LABEL = 'Forum Post'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvForumPostChangeDetail]
  action: [detail: UvForumPostChangeDetail]
}>()
