...
import type { UvSocialLinksChangeDetail } from './social-links.types'

const COMPONENT_LABEL = 'Social Links'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvSocialLinksChangeDetail]
  action: [detail: UvSocialLinksChangeDetail]
}>()
