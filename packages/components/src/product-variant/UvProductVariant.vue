...
import type { UvProductVariantChangeDetail } from './product-variant.types'

const COMPONENT_LABEL = 'Product Variant'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvProductVariantChangeDetail]
  action: [detail: UvProductVariantChangeDetail]
}>()
