...
import type { UvQueryResultChangeDetail } from './query-result.types'

const COMPONENT_LABEL = 'Query Result'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvQueryResultChangeDetail]
  action: [detail: UvQueryResultChangeDetail]
}>()
