...
import type { UvAnchorNavChangeDetail } from './anchor-nav.types'

const COMPONENT_LABEL = 'Anchor Nav'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvAnchorNavChangeDetail]
  action: [detail: UvAnchorNavChangeDetail]
}>()
