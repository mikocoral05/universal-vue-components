...
import type { UvProductGalleryChangeDetail } from './product-gallery.types'

const COMPONENT_LABEL = 'Product Gallery'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvProductGalleryChangeDetail]
  action: [detail: UvProductGalleryChangeDetail]
}>()
