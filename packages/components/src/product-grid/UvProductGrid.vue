...
import type { UvProductGridChangeDetail } from './product-grid.types'

const COMPONENT_LABEL = 'Product Grid'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvProductGridChangeDetail]
  action: [detail: UvProductGridChangeDetail]
}>()
