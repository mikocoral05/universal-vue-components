...
import type { UvRecordingIndicatorChangeDetail } from './recording-indicator.types'

const COMPONENT_LABEL = 'Recording Indicator'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvRecordingIndicatorChangeDetail]
  action: [detail: UvRecordingIndicatorChangeDetail]
}>()
