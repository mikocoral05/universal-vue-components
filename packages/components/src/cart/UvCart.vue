...
import type { UvCartChangeDetail } from './cart.types'

const COMPONENT_LABEL = 'Cart'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvCartChangeDetail]
  action: [detail: UvCartChangeDetail]
}>()
...
<template>
<article class="uv-next uv-cart" :class="`uv-next--${tone}`" data-uv-component="UvCart" :aria-label="accessibleLabel">
