...
import type { UvStepNavChangeDetail } from './step-nav.types'

const COMPONENT_LABEL = 'Step Nav'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvStepNavChangeDetail]
  action: [detail: UvStepNavChangeDetail]
}>()
