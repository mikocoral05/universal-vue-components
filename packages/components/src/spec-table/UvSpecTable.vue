...
import type { UvSpecTableChangeDetail } from './spec-table.types'

const COMPONENT_LABEL = 'Spec Table'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvSpecTableChangeDetail]
  action: [detail: UvSpecTableChangeDetail]
}>()
