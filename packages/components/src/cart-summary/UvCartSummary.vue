...
import type { UvCartSummaryChangeDetail } from './cart-summary.types'

const COMPONENT_LABEL = 'Cart Summary'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvCartSummaryChangeDetail]
  action: [detail: UvCartSummaryChangeDetail]
}>()
