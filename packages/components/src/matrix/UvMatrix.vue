...
import type { UvMatrixChangeDetail } from './matrix.types'

const COMPONENT_LABEL = 'Matrix'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvMatrixChangeDetail]
  action: [detail: UvMatrixChangeDetail]
}>()
