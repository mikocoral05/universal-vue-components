...
import type { UvDataTableChangeDetail } from './data-table.types'

const COMPONENT_LABEL = 'Data Table'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvDataTableChangeDetail]
  action: [detail: UvDataTableChangeDetail]
}>()
