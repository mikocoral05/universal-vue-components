...
import type { UvContactActionsChangeDetail } from './contact-actions.types'

const COMPONENT_LABEL = 'Contact Actions'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvContactActionsChangeDetail]
  action: [detail: UvContactActionsChangeDetail]
}>()
