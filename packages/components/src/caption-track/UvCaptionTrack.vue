...
import type { UvCaptionTrackChangeDetail } from './caption-track.types'

const COMPONENT_LABEL = 'Caption Track'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvCaptionTrackChangeDetail]
  action: [detail: UvCaptionTrackChangeDetail]
}>()
