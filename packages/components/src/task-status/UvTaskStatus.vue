...
import type { UvTaskStatusChangeDetail } from './task-status.types'

const COMPONENT_LABEL = 'Task Status'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvTaskStatusChangeDetail]
  action: [detail: UvTaskStatusChangeDetail]
}>()
