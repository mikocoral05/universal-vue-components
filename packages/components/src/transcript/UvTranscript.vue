...
import type { UvTranscriptChangeDetail } from './transcript.types'

const COMPONENT_LABEL = 'Transcript'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvTranscriptChangeDetail]
  action: [detail: UvTranscriptChangeDetail]
}>()
