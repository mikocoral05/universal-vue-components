...
import type { UvConnectionStatusChangeDetail } from './connection-status.types'

const COMPONENT_LABEL = 'Connection Status'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvConnectionStatusChangeDetail]
  action: [detail: UvConnectionStatusChangeDetail]
}>()
