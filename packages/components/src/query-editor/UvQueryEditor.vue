...
import type { UvQueryEditorChangeDetail } from './query-editor.types'

const COMPONENT_LABEL = 'Query Editor'
interface Props {
...
const emit = defineEmits<{
  ...
  change: [detail: UvQueryEditorChangeDetail]
  action: [detail: UvQueryEditorChangeDetail]
}>()
